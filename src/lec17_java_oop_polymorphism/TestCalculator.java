...
public class TestCalculator {
	...
	public static void main(String[] args) {
		...
		LandCalculator.landCalculator(8, 4, 33, 6, 41); // static method -06initialized
		lc.landCalculator(2, 10, 20, 40, 90, 80); // void type parameterized method -07initialized
		...
		mc.landCalculator(2, 10, 20, 40, 90, 80); // void type parameterized method -07initialized
		mc.landCalculator(); // void type method -08initialized
