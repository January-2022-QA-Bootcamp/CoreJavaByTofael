package lec44_java_control_statements;

// any loop inside another loop is called nested loop, the outer one is called outer loop, the inner one is called inner loop
